...
if __name__ == '__main__':
    ...
    while True:
        ...
        #print N, value, curTime, sampleCounter, lastBeatTime

        ##  find the peak and trough of the pulse wave
        if value < thresh and N > (IBI/5.0)*3.0 :  #       # avoid dichrotic noise by waiting 3/5 of last IBI
        ...
        if value > thresh and  value > P:           # thresh condition helps avoid noise
          ...
          # value surges up in value every time there is a pulse
        if N > 250 :                                   # avoid high frequency noise
            if  (value > thresh) and  (Pulse == False) and  (N > (IBI/5.0)*3.0)  :       
        ...
        if value < thresh and Pulse == True :   # when the values are going down, the beat is over
